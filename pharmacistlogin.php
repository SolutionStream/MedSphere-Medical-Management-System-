...
{
	echo "<script>window.location='pharmacistaccount.php';</script>";
}
$err='';
if(isset($_POST[submit]))
{
	$sql = "SELECT * FROM pharmacist WHERE loginid='$_POST[loginid]' AND password='$_POST[password]' AND status='Active'";
	$qsql = mysqli_query($con,$sql);
	if(mysqli_num_rows($qsql) >= 1)
	{
		$rslogin = mysqli_fetch_array($qsql);
		$_SESSION[pharmacist_id]= $rslogin[pharmacist_id] ;
		echo "<script>window.location='pharmacistaccount.php';</script>";
	}
	else
	{
...
<div class="d-lg-flex half">
    ...
    <div class="bg order-1 order-md-2" style="background-image: url('loginMain/images/pharmacy automation.jpg');"></div>
      ...
      <div class="container">
        <div class="row align-items-center justify-content-center">
		  ...
		  <a href="https://medsphere.tk/">
            ...
            <h3><strong>Pharmacist</strong> Login</h3>
