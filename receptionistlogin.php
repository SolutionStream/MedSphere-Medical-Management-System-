...
if(isset($_POST[submit]))
{
	...
	if(mysqli_num_rows($qsql) >= 1)
	{
		...
		$_SESSION[receptionist_id]= $rslogin[receptionist_id] ;
		echo "<script>window.location='receptionistaccount.php';</script>";
	}
	else
	{
...
<div class="d-lg-flex half">
    ...
    <div class="bg order-1 order-md-2" style="background-image: url('loginMain/images/Receptionist-big-main.jpg');"></div>
      ...
      <div class="container">
        <div class="row align-items-center justify-content-center">
		  ...
		  <a href="https://medsphere.tk/">
            ...
            <h3><strong>Receptionist</strong> Login</h3>
