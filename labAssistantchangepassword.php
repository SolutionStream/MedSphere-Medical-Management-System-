...
{
	$sql = "UPDATE labAssistant SET password='$_POST[newpassword]' WHERE labAssistantId='$_SESSION[labAssistantId]'";
	...
	$sql = "UPDATE users SET password='$_POST[newpassword]' WHERE deletID='$_SESSION[labAssistantId] AND loginid='$_POST[email]''";
	$qsql= mysqli_query($con,$sql);
	if(mysqli_affected_rows($con) == 1)
	{
		echo "<script>alert('Password has been updated successfully..');</script>";
...
<div class="container-fluid">
    <div class="block-header">
        <h2 class="text-center"> LabAssistant's Password</h2>
    </div>
