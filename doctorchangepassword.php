...
{
	$sql = "UPDATE doctor SET password='$_POST[newpassword]' WHERE doctorid='$_SESSION[doctorid]'";
	...
	$sql = "UPDATE users SET password='$_POST[newpassword]' WHERE deletID='$_SESSION[doctorid] AND loginid='$_POST[email]''";
	$qsql= mysqli_query($con,$sql);
	if(mysqli_affected_rows($con) == 1)
	{
		echo "<script>alert('Password has been updated successfully..');</script>";
