		...
		<table class="table table-bordered table-striped table-hover js-basic-example dataTable">
			...
			<tbody>
				...
				while($rs = mysqli_fetch_array($qsql))
				{
					...
					<td>$rs[status]</td>
					<td>&nbsp;
					<a href='receptionist.php?editid=$rs[receptionist_id]' class='btn btn-sm btn-raised g-bg-cyan'>Edit</a> <a href='viewReceptionist.php?delid=$rs[receptionist_id]' class='btn btn-sm btn-raised g-bg-blush2'>Delete</a> </td>
					</tr>";
				}
				?>      </tbody>
			</table>
