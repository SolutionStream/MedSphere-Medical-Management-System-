    ...
    <table class="table table-bordered table-striped table-hover js-basic-example dataTable">
      ...
      <tbody>
       ...
       while($row = mysqli_fetch_array($qsql))
       {
            ...
            <td align='center'>
            <a href='viewPrescriptionPharmacist.php?prescriptionActiveId=$row[prescriptionid]' class='btn btn-sm btn-raised g-bg-cyan'>Undone</a> <br>
            <a href='viewPrescriptionPharmacist.php?prescriptionDeactiveId=$row[prescriptionid]' class='btn btn-sm btn-raised g-bg-blush2'>Done</a>  </td>
           }
            </tr>";
