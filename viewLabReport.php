  ...
  <div class="card">
    <section class="container">
      <table class="table table-bordered table-striped table-hover js-basic-example dataTable">
        ...
        <td align='center'> 
        <a href='labreportDownload.php?labReportDownload=$row[labreportid]' class='btn btn-sm btn-raised g-bg-cyan' >Download</a> 
        


        <td align='center'> $row[status] <br>
        <a href='viewLabReport.php?labReportActiveId=$row[labreportid]' class='btn btn-sm btn-raised g-bg-cyan'>Active</a> <br>
        <a href='viewLabReport.php?labReportDeactiveId=$row[labreportid]' class='btn btn-sm btn-raised g-bg-blush2'>Deactive</a>  </td>



        <td>&nbsp;
        <a href='labReport.php?editid=$row[labreportid]' class='btn btn-sm btn-raised g-bg-cyan'>Edit</a> 
        <a href='viewLabReport.php?delid=$row[labreportid]' class='btn btn-sm btn-raised g-bg-blush2'>Delete</a> </td>
