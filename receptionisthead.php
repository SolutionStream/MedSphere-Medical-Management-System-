...
<body class="theme-cyan">
    ...
    <nav class="navbar clearHeader">
        <div class="col-12">
            ...
            <!-- Notifications -->
                <li>
                    <a data-placement="bottom" title="Log out!" href="logout.php"><i
        ...
        <aside id="leftsidebar" class="sidebar">
            ...
            <div class="menu">
                <ul class="list" style="overflow: hidden; width: auto; height: calc(-184px + 100vh);">
                    ...
                    <li><a href="javascript:void(0);" class="menu-toggle"><i
                                class="zmdi zmdi-calendar-check"></i><span>Labratory</span> </a>
                        <ul class="ml-menu">
                            <li><a href="adminprofile.php">Labratory Profile</a></li>
                            <li><a href="adminchangepassword.php">Change Password</a></li>
                            <li><a href="admin.php">Add Labratory</a></li>
                            <li><a href="viewadmin.php">View Labratory</a></li>
                        </ul>
                    </li>
                    ...
                    <li><a href="javascript:void(0);" class="menu-toggle"><i
                                class="zmdi zmdi-calendar-check"></i><span>Pharmacist</span> </a>
                        <ul class="ml-menu">
                            <li><a href="adminprofile.php">Pharmacist Profile</a></li>
                            <li><a href="adminchangepassword.php">Change Password</a></li>
                            <li><a href="admin.php">Add Pharmacist</a></li>
                            <li><a href="viewadmin.php">View Pharmacist</a></li>
                        </ul>
                    </li>
                    ...
                    <li><a href="javascript:void(0);" class="menu-toggle"><i
                                class="zmdi zmdi-calendar-check"></i><span>Service</span> </a>
                        <ul class="ml-menu">
                        <li><a href="department.php" class=" waves-effect waves-block">Add Department</a></li>
                            <li><a href="viewdepartment.php" class=" waves-effect waves-block">View Department</a></li>
                            <li><a href="treatment.php" class=" waves-effect waves-block">Add Treatment type</a></li>
