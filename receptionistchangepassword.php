...
{
	$sql = "UPDATE receptionist SET password='$_POST[newpassword]' WHERE receptionist_id='$_SESSION[receptionist_id]'";
	...
	$sql = "UPDATE users SET password='$_POST[newpassword]' WHERE deletID='$_SESSION[receptionist_id] AND loginid='$_POST[email]''";
	$qsql= mysqli_query($con,$sql);
	if(mysqli_affected_rows($con) == 1)
	{
		echo "<script>alert('Password has been updated successfully..');</script>";
...
<div class="container-fluid">
    <div class="block-header">
        <h2 class="text-center"> Receptionist's Password</h2>
    </div>
