...
if(isset($_POST[submit]))
{
	...
	{
		$sql ="UPDATE receptionist SET name='$_POST[name]',loginid='$_POST[loginid]',password='$_POST[password]',status='$_POST[select]',email='$_POST[email]',phone='$_POST[phone]',address='$_POST[address]' WHERE receptionist_id=='$_GET[editid]'";
		...
		else
		{
			echo mysqli_error($con);
				...
				//update user table
				$sql = "UPDATE users SET loginid='$_POST[loginid]',password='$_POST[password]',type='receptionist',email='$_POST[email]' WHERE deletID='$_GET[editid]'";
				if ($qsql = mysqli_query($con, $sql)) {
					echo "<div class='alert alert-success'>
					Receptionist Record updated successfully
					</div>";
				} else {
					echo mysqli_error($con);
				}
	...
	{
		$sql ="INSERT INTO receptionist(name,loginid,password,status,email,address,phone) values('$_POST[name]','$_POST[loginid]','$_POST[password]','$_POST[select]','$_POST[email]','$_POST[address]','$_POST[phone]')";
		if($qsql = mysqli_query($con,$sql))
		{
			echo "<div class='alert alert-success'>
		...
		/////select data from receptionist database to get deleteid of user tablae
		$sql = "SELECT * FROM receptionist WHERE loginid='$_POST[loginid]'  ";
		$qsql = mysqli_query($con, $sql);
		$getDeleteIDfromUser = mysqli_fetch_array($qsql);

		$getdoctorid = $getDeleteIDfromUser[receptionist_id];
	...
	$sql ="INSERT INTO users(loginid,type,password,email,deletID) values('$_POST[loginid]','receptionist','$_POST[password]','$_POST[email]','$getdoctorid')";
	if($qsql = mysqli_query($con,$sql))
	{
		echo "<div class='alert alert-success'>
...
if(isset($_GET[editid]))
{
	$sql="SELECT * FROM receptionist WHERE receptionist_id='$_GET[editid]' ";
	$qsql = mysqli_query($con,$sql);
...
<div class="container-fluid">
	<div class="block-header">
		<h2 class="text-center"> Add New Receptionist </h2>
	</div>
				...
				<form method="post" action="" name="frmadminprofile" >
					...
					<div class="body">
						...
						<div class="row clearfix"> 
							<div class="col-sm-12">                           
								<div class="form-group">
									<label>Receptinist Login Id </label>
									<div class="form-line">
                        ...
                        <div class="row clearfix">
							<div class="col-sm-12">   
								<div class="form-group">
									<label> Receptionist Address</label>
									<div class="form-line">
