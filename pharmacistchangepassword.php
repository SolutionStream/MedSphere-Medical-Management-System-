...
{
	$sql = "UPDATE pharmacist SET password='$_POST[newpassword]' WHERE pharmacist_id='$_SESSION[pharmacist_id]'";
	...
	$sql = "UPDATE users SET password='$_POST[newpassword]' WHERE deletID='$_SESSION[pharmacist_id]'  AND loginid='$_POST[email]'";
	$qsql= mysqli_query($con,$sql);
	if(mysqli_affected_rows($con) == 1)
	{
		echo "<script>alert('Password has been updated successfully..');</script>";
...
<div class="container-fluid">
    <div class="block-header">
        <h2 class="text-center"> Pharmacist's Password</h2>
    </div>
