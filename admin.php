...
if(isset($_POST[submit]))
{
	...
	{
		$sql ="UPDATE admin SET adminname='$_POST[adminname]',loginid='$_POST[loginid]',password='$_POST[password]',status='$_POST[select]',email='$_POST[email]' WHERE adminid='$_GET[editid]'";
		...
		//update user table
		$sql ="UPDATE users SET loginid='$_POST[loginid]',password='$_POST[password]',type='admin',email='$_POST[email]' WHERE deletID='$_GET[editid]'";
		if($qsql = mysqli_query($con,$sql))
		{
			echo "<div class='alert alert-success'>
			Admin Record updated successfully
	...
	{
		$sql ="INSERT INTO admin(adminname,loginid,password,status,email) values('$_POST[adminname]','$_POST[loginid]','$_POST[password]','$_POST[select]','$_POST[email]')";
		if($qsql = mysqli_query($con,$sql))
		{
			echo "<div class='alert alert-success'>
		...
		else
		{
			...
			/////select data from Admin database to get deleteid of user tablae
	$sql="SELECT * FROM admin WHERE loginid='$_POST[loginid]'  ";
	$qsql = mysqli_query($con,$sql);
	$getDeleteIDfromUser = mysqli_fetch_array($qsql);

	$adminidfromadmin = $getDeleteIDfromUser[adminid];
	...
	$sql ="INSERT INTO users(loginid,type,password,email,deletID) values('$_POST[loginid]','admin','$_POST[password]','$_POST[email]','$adminidfromadmin')";
	if($qsql = mysqli_query($con,$sql))
	{
		echo "<div class='alert alert-success'>
