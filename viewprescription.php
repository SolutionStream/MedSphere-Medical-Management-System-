    ...
    <table class="table table-bordered table-striped table-hover js-basic-example dataTable">
      ...
      <tbody>
       ...
       while($row = mysqli_fetch_array($qsql))
       {
        ...
        <a href='viewprescription.php?prescriptionActiveId=$row[prescriptionid]' class='btn btn-sm btn-raised g-bg-cyan'>Active</a> <br>
        <a href='viewprescription.php?prescriptionDeactiveId=$row[prescriptionid]' class='btn btn-sm btn-raised g-bg-blush2'>Deactive</a>  </td>

        <td>&nbsp;
        <a href='prescriptionform.php?editid=$row[prescriptionid]' class='btn btn-sm btn-raised g-bg-cyan'>Edit</a> 
        <a href='viewprescription.php?delid=$row[prescriptionid]' class='btn btn-sm btn-raised g-bg-blush2'>Delete</a> </td>
